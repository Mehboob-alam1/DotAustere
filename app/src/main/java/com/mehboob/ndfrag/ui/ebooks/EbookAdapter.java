...
public class EbookAdapter extends RecyclerView.Adapter<EbookAdapter.EbookViewHolder> {
    ...
    public void onBindViewHolder(@NonNull EbookViewHolder holder, int position) {
        EbookModel data = list.get(position);
        holder.ebookName.setText(data.getPdfTitle());
        holder.itemView.setOnClickListener(view -> {
            Intent intent = new Intent(context, PdfViewActivity.class);
            intent.putExtra("pdfurl", data.getPdfUrl());
            context.startActivity(intent);
        });
        holder.btndownlaod.setOnClickListener(view -> {
    ...
    public static class EbookViewHolder extends RecyclerView.ViewHolder {
        ...
        public EbookViewHolder(@NonNull View itemView) {
            ...
            ebookName = itemView.findViewById(R.id.pdfName);
            btndownlaod = itemView.findViewById(R.id.btnEbookDownload);
        }
    }
}
